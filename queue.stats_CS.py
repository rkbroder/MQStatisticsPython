...
###          
            outputL=queue_name + ',' + creationdate + ',' + creationtime + ',' + qtype + ',' + qdefinationtype + ',' + queuedepth + ',' + str(highdepth) + ',' + queueavgtime + ',' + mqputcount + ',' + mqputbackoutcount + ',' + mqputcount + ',' + mqputbytecount + ',' + mqgetcount + ',' + mqgetbytecount + ',' + mqgetdestfail + ',' + str(browses) + ',' + str(browseBytes) + ',' + str(browseFailed) + ',' + msgNotQueued + ',' + expiredmessages + ',' + queuepurgcount + ',' + queueManager + ',' + str(dt) + "\n"
            qstatsreport.write(outputL)   
    qstatsreport.close()
    return rc 
